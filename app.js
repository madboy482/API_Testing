...
app.get('/', (req, res) => {
  res.send(`
    ...
    <ul>
      <li><strong>POST</strong> <code>/api/schools</code> – Add a new school</li>
      <li><strong>GET</strong> <code>/api/schools?latitude=12.97&longitude=77.59</code> – List schools sorted by proximity</li>
    </ul>
